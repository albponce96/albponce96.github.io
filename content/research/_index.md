...
<p class="tl-syn">Evaluó la efectividad de un programa piloto de tutorías financieras personalizadas para fortalecer la gestión financiera de líderes del turismo comunitario rural, afectados económicamente por la COVID-19.</p>
<ul class="tl-bullets"><li>27 líderes comunitarios de los distritos de Yanque y Coporaque (Valle del Colca, Arequipa).</li><li>Aplicó el marco conductual <strong>BASIC de la OCDE</strong> mediante sesiones y acompañamiento virtual.</li><li>Fortaleció los <strong>Conocimientos, Actitudes y Prácticas (CAP)</strong> de gestión financiera comunitaria.</li></ul>
...
<p class="tl-syn">Analiza el movimiento GovTech como estrategia clave para modernizar la gestión pública y restaurar la confianza entre la ciudadanía y el Estado en América Latina.</p>
<ul class="tl-bullets"><li>Oportunidades y desafíos regulatorios del ecosistema GovTech regional.</li><li>Modelos de financiamiento e iniciativas de emprendimiento tecnológico.</li><li>Enfoque en soluciones a desafíos sociales de la región.</li></ul>
<a class="tl-link" href="https://futuropublico.org/blog/serie-govtech" target="_blank" rel="noopener">Ver publicación →</a>
</div>
</div>
...
<p class="tl-syn">Estudio cualitativo y exploratorio sobre el potencial de los laboratorios de innovación en el sector público del turismo en economías emergentes como el Perú.</p>
<ul class="tl-bullets"><li>Más del 75% de las unidades de innovación se concentran en economías desarrolladas.</li><li>Identifica habilitadores organizacionales y factores condicionantes.</li><li>Propone componentes para institucionalizar los labs en la gestión pública.</li></ul>
</div>
</div>
...
<p class="tl-syn">Analiza las consecuencias socioeconómicas de la COVID-19 en los destinos turísticos peruanos con cuota de mercado predominantemente internacional.</p>
<ul class="tl-bullets"><li>Contracción del flujo receptivo e ingresos de los hogares.</li><li>Riesgos de precarización laboral e informalidad.</li><li>Opciones de política laboral, financiera, de demanda interna y reinvención de productos.</li></ul>
...
<p class="tl-syn">Propone un Bono de Impacto Social (BIS) modificado como instrumento innovador de política pública para facilitar la primera experiencia laboral juvenil en el Perú.</p>
<ul class="tl-bullets"><li>Aborda la baja productividad, la informalidad y el desempleo juvenil.</li><li>Combina herramientas de <em>crowdsourcing</em> y pasantías directas.</li><li>Conecta el talento joven con organizaciones turísticas sostenibles.</li></ul>
...
(function () {
  ...
  function setActiveChip(topic) {
    for (var i = 0; i < chips.length; i++) {
      chips[i].classList.toggle('active', chips[i].getAttribute('data-topic') === topic);
    }
  }
  ...
  for (var i = 0; i < chips.length; i++) {
    (function (chip) {
      chip.addEventListener('click', function () { filterByTopic(chip.getAttribute('data-topic')); });
    })(chips[i]);
  }
